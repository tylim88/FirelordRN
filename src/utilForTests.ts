...
export const grandChildRefCreator = () =>
	getFirelord<GrandChild>(undefined, `topLevel`, `Users`, 'GrandChild')
...
export const compareWriteDataWithDocSnapData = (
	...
	if (readData) {
		...
		data.a.b.f = (
			...
			item.h = fs.Timestamp.fromDate(item.h as Date)
			return item
		})
		// convert field value
		data.a.i.l = fs.Timestamp.fromDate(data.a.i.l as Date)
